...
//Accedemos al parrafo que nos permitira imprimir el resultado const parrafo = document.querySelector("#idParrafo");
console.log(parrafo);

//Accedemos a cada boton por medio de la API DOM
const btnSumar = document.querySelector("#idBtnSumar");
const btnRestar = document.querySelector("#idBtnRestar"); const btnMultiplicar = document.querySelector("#idBtnMultiplicar");
...
btnMultiplicar.addEventListener("click", multiplicar) btnDividir.addEventListener("click", dividir);
;
...
let numero2 prompt ("Ingrese el segundo numero a sumar"); resultado = numero1 + numero2; =
...
=
function restar() {
let numero2 prompt ("Ingrese el segundo numero a restar"); resultado = numerol numero2;
parrafo.innerHTML ${numero1} ${numero2} = ${resultado}`; -
}
...
resultado = numero1 * numero2; parrafo.innerHTML ${numero1} x ${numero2} = ${resultado}` =
}
