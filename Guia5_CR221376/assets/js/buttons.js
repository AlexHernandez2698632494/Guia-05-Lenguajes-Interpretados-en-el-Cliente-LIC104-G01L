...
function confirmacion() {
    ...
    /* para imprimir una variable en una cadena podemos utilizar las comillas simples inversas y luego hacemos el llamado de la variable con ${aqui debera de escribir el nombre de la variable} */
