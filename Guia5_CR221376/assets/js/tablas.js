...
table += "<td>Vanessa Alejandra</td>"; table += "<td>Bermudez Urquilla</td>";
table += "<td>vanessa.bermudez@estudiante.udb.edu.sv</td>";
table += "</tr>"; table += "<tr>";
table += "<td scope='row'>5</td>"; table += "<td>Oscar Armando</td>";
table += "<td>López Rodriguez</td>"; table += "<td>oscar.lopez@estudiante.udb.edu.sv</td>";
table += "</tr>";
table += "</tbody>";
table += "</table>";
